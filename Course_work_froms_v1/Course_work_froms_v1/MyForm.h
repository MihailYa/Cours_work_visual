...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->richTextBox1->Size = System::Drawing::Size(102, 132);
			...
			this->checkBox2->Size = System::Drawing::Size(177, 24);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Open Sans", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			...
			this->checkBox4->Size = System::Drawing::Size(310, 24);
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (this->checkBox1->Checked || this->checkBox2->Checked)
		{
			if (this->checkBox1->Checked && this->checkBox2->Checked)
			{
				...
				if (this->checkBox4->Checked)
				{
					...
					{
						MessageBox::Show("Вкажіть джерело та стік!");
						return;
					}
		...
		if (this->radioButton1->Checked)
		{
			...
			if (this->checkBox3->Checked)
			{
				...
				{
					MessageBox::Show("Введіть назву файлу, в якому потрібео зберегти граф!");
					return;
				}
				else
				{
					...
					{
						MessageBox::Show("Не можливо відкрити файл для збереження графу.");
						return;
					}
					int n = temp.length();
					for (int i = 0; i < n; i++)
			...
			Course_work_froms_v1::MyForm_^ form_ = gcnew MyForm_(mode, gr, vers, ss);
			form_->Show();
		}
		else
		{
